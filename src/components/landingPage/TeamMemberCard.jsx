...
function TeamMemberCard({imgpath, name, role, alt}) {
  return (
    <div className='relative w-[227px] h-[271px] bg-white ml-5 rounded-[3px] '>
        <img className="absolute rounded-[3px]" src="/landingpage/membercardbg.png" alt='bg'></img>
        <div className='absolute px-4'>
        <div className='w-[194px] h-[184px] bg-[#94BFFF]  mt-4 rounded-[3px] '>
          <img className='absolute top-[-50px]' src={imgpath} alt={alt}></img>
        </div>
